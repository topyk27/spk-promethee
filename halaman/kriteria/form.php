...
<div class="row form-group">
	...
	<div class="col-lg-9">
		<select class="form-control" name="jenis">
			...
			<option value="Benefit" <?php if(isset($data_calon[0]) && $data_calon[0]['jenis']=='Benefit') echo "selected"; ?>>Benefit</option>
			<option value="Cost" <?php if(isset($data_calon[0]) && $data_calon[0]['jenis']=='Cost') echo "selected"; ?>>Cost</option>
		</select>
	</div>
</div>
